...
<body>
    ...
    <div class="recuadros-container">
        ...
        <div class="boton-" onclick="realizarOtraAccion2()">
            <p><b>Odontología</b></p>
            <i class="fa-solid fa-stethoscope"></i>
            <p>*************************</p>
        </div>

        <div class="boton-" onclick="realizarOtraAccion3()">
            <p><b>Dermatología</b></p>
            <i class="fa-solid fa-stethoscope"></i>
            <p>*************************</p>
        </div>

        <div class="boton-" onclick="realizarOtraAccion4()">
            <p><b>Huesos</b></p>
            <i class="fa-solid fa-stethoscope"></i>
            <p>*************************</p>
        </div>

        <div class="boton-" onclick="realizarOtraAccion5()">
            <p><b>Ginecología</b></p>
            <i class="fa-solid fa-stethoscope"></i>
            <p>*************************</p>
        </div>

        <div class="boton-" onclick="realizarOtraAccion6()">
            <p><b>Otros</b></p>
            <i class="fa-solid fa-stethoscope"></i>
            <p>*************************</p>
        </div>
    ...
    <div class= "contactos">
        ...
        <div class="cuadro-containe">
            ...
            <div class="boton-cuadro" id= "cuadro2" onclick="realizarOtraAccion7()">
                <h3>Ubicación</h3>
            ...
            <div class="boton-cuadro" id= "cuadro3" onclick="realizarOtraAccion7()">
                <h3>Contacto</h3>
